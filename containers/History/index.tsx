                    ...
                    return (
                        <>
                            ...
                            <Grid item xs={4} key={index.id}>
                                ...
                                <Grid item xs={1}>
                                    <Box sx={{ border: '1px solid rgba(40, 38, 38, 0.1)', mt: 2, width: '323px', ml: 1, height: '0px' }} />
                                </Grid>
                            </Grid>
                        </>
                    );
                    ...
                    return (
                        <>
                            ...
                            <Grid item xs={4} key={index.id}>
                                ...
                                <Grid item xs={1}>
                                    <Box sx={{ border: '1px solid rgba(40, 38, 38, 0.1)', mt: 2, width: '333px', mr: 2, height: '0px' }} />
                                </Grid>
                            </Grid>
                            {/* <Box sx={{ border: '1px solid rgba(40, 38, 38, 0.1)', mt: 2, width: '353px', ml: 1 }} /> */}
                        </>
                    );
                })}
            </Grid>
