...
const HistoryCard: React.FC<HistoryCardProps> = ({ isOngoing, isDone, isHighScores, isJoined, isPlace }) => {
    return (
        <Grid container alignItems='center' gap='15px' borderBottom='1px solid rgba(40, 38, 38, 0.1)' padding='20px 0px'>
            <Grid item xs={2}>
            ...
            <Grid item xs={3}>
                <Box>
                    {isOngoing && <Button title='Go' backgoundColor='#A54CE5' color='white' height='40px' />}
                    {isDone && (
