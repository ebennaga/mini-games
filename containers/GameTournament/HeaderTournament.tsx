                                ...
                                <Box sx={{ mt: '0px', display: 'flex', gap: '30px' }}>
                                    <Box sx={{ ml: '-155px', transform: 'rotate(90deg)', width: '180px', position: 'relative' }}>
                                        ...
                                        >
                                            <Box />
                                            <img
                                                src={value >= 40 ? '/images/step-poin.png' : '/images/step.png'}
                                                alt='step'
                                                loading='lazy'
                                            />
                                            <img
                                                src={value >= 60 ? '/images/step-poin.png' : '/images/step.png'}
                                                alt='step'
                                                loading='lazy'
                                            />
                                            <img
                                                src={value >= 80 ? '/images/step-poin.png' : '/images/step.png'}
                                                alt='step'
                                                loading='lazy'
                                            />
                                        </Box>
