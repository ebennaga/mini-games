    ...
    return(
        <Box>
            ...
            <Box sx={{display: "flex", alignItems: "center",justifyContent:"center",flexDirection:"column",marginTop:'28px'}}>
                ...
                <Typography component='span' fontWeight={400} fontSize='12px' sx={{ color: '#949494',whiteSpace: 'pre-wrap',textAlign:'center',marginTop:'14px', marginBottom:'14px',paddingLeft:'28px',paddingRight:'28px' }}>
                    Ruko Crystal 1, Jalan Gading Golf Boulevard No. 19 Gading Serpong, Pakulonan Bar., Kec. Klp. Dua, Kabupaten Tangerang, Banten 15810
                </Typography>
